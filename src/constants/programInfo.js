...
export const schoolInfo = {
  ...
  APRRange36: "12.11 - 12.21%",
  APRRange60: "13.32 - 13.37%",
  interestOnly: [
    {
...
export const leadContent = {
  ...
  paragraph: `${schoolName} offers a variety of programs to provide students a foundation for a career in software development and UX/UI design. ${schoolName} partners with Skills Fund to offer tuition${
...
export const programLoanInfo = [
  // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKBURJS19",
    loanInfo: {
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKBU18",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 9950,
      loanTerm36: true,
